...
# Variables
FOLDERNAME="result38_stl_10_beta_0.9999_20_20"
...
RATIO=2.0
IMB_L=20
IMB_U=20        # Not Relevant in STL-10 (Only used in Dojo Test Settings)
VAL_ITER=500
NUM_VAL=10
...
CONST=0.9999         # Hyperparameter for W_L Formula (Comment if not using)
