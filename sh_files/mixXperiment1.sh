...
BASEDIR="experiments"
FOLDERDIR="${BASEDIR}/${DATASET}/MixMatch/${FOLDERNAME}"
...
DISTBL="uniform"   # "uniform": To use Uniform Weights (All Ones, similar to default FixMatch)
...
mkdir ${BASEDIR}/${DATASET}/MixMatch
mkdir $FOLDERDIR 
